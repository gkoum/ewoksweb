...
const formatDecimal = (value) => Number(Number.parseFloat(value).toFixed(2));

function Popover({ anchor, onClose, nodeData }) {
              ...
              {data.data.analytics.map(({ value, label, color }, index) => (
                <TableRow key={index}>
                  ...
                  <TableCell style={{ textAlign: 'right' }}>
                    {formatDecimal((value / data.data.potentialTarget) * 100)} %
                  </TableCell>
                </TableRow>
              ))}
              <TableRow>
                ...
                <TableCell style={{ textAlign: 'right' }}>
                  {formatDecimal(
                    (notReachedValue / data.data.potentialTarget) * 100
                  )}{' '}
                  %
                </TableCell>
              </TableRow>
